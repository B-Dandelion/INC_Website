    ...
    <main className="min-h-screen bg-[#F6F7F9]">
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-5xl px-5 py-12 md:px-6 md:py-16">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-[-0.035em] text-slate-950 md:text-4xl">문의</h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 md:text-[15px]">
            INC 관련 문의, 제휴 및 협력 제안은 아래 연락처를 이용해 주세요.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-5 py-10 md:px-6 md:py-14">
        <div className="grid border border-slate-200 bg-white md:grid-cols-3">
          <div className="border-b border-slate-200 p-6 md:border-b-0 md:border-r">
            ...
            <div className="mt-2 text-sm leading-7 text-slate-700">{contactInfo.address}</div>
          </div>
          ...
          <div className="border-b border-slate-200 p-6 md:border-b-0 md:border-r">
            ...
            <a
              ...
              className="mt-2 inline-block text-sm font-semibold text-slate-800 transition hover:text-[#174A7E]"
            >
              {contactInfo.phone}
            </a>
          </div>
          ...
          <div className="p-6">
            ...
            <a
              ...
              className="mt-2 inline-block break-all text-sm font-semibold text-slate-800 transition hover:text-[#174A7E]"
            >
              {contactInfo.email}
            </a>
          </div>
